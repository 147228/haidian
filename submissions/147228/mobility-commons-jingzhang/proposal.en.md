...
The population-scale method references are `MATSIM-LARGE-SCALE-ABM`, `MATSIM-BOOK-ACTIVITY-BASED`, `ACTIVITY-BASED-DISAGGREGATE-2001` and `ACCEQ-DRT-2023`; they motivate activity chains, full-population replay, capacity feedback and future equity-oriented feeder candidates, but do not supply Haidian coefficients or outcomes.
